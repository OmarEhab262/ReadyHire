    ...
    <Layout>
      <div className="min-h-screen flex flex-col bg-gray-100">
        <div className="flex items-center justify-center p-4 mt-3">
          <h2 className="text-3xl font-bold mb-4 text_secondary">Negotiate</h2>
        </div>

        <div className="flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-2xl bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">Negotiate List</h3>
            ...
            <div className="flex flex-row flex-wrap gap-6 w-full md:justify-between justify-center my-5">
              <CustomButton
                text="Cancel"
                ...
                width="200px"
              />
              <CustomButton text="Accept" height="40px" width="200px" />
            </div>
          </div>
        </div>
      </div>
