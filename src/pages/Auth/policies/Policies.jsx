import policies1 from "../../../components/images/ddddd.svg";
import policies2 from "../../../components/images/policies2.svg";
import policies3 from "../../../components/images/policies3.svg";
const Policies = () => {
  return (
    <div className="p-10 ">
      ...
      <div className="flex justify-center items-center gap-10 p-3 flex-col md:w-[60%] w-[90%] mx-auto">
        ...
        <div>
          ...
          <p className="text-gray-600  leading-loose ">
            ...
            allowed to participate in the project after completion, both in his
            personal exhibition and on other platforms, subject to the
            employer&apos;s consent.
            <br />
        ...
        <div>
          ...
          <p className="text-gray-600  leading-loose ">
            ...
            only through the internal chat system to ensure security and protect
            the rights of the parties.
            <br />
            4.User Data Protection: All data is encrypted and not sold or shared
            with third parties. Users can delete their accounts and data
            completely upon request. necessary.
          </p>
        </div>
        <div>
          <h3 className="flex gap-2 text-[30px] font-semibold">
          ...
          <p className="text-gray-600  leading-loose ">
            ...
            successfully delivered. In case of dispute, the platform can review
            the files and communicate with the parties to resolve the problem
            according to the evidence provided. If the freelancer does not
            commit to delivery, the amount can be refunded to the employer after
            reviewing the order.
          </p>
        </div>
      </div>
